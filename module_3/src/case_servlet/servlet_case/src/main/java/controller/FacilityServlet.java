...
public class FacilityServlet extends HttpServlet {
    ...
    private void addRoom(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            request.getRequestDispatcher("view/facility/addRoom.jsp.jsp").forward(request, response);
        } catch (ServletException e) {
            e.printStackTrace();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    private void addHouse(HttpServletRequest request, HttpServletResponse response) {
        ...
        facilityService.addFacility(newfacility);
        try {
            request.getRequestDispatcher("view/facility/addHouse.jsp").forward(request, response);
        } catch (ServletException e) {
            e.printStackTrace();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    private void addVilla(HttpServletRequest request, HttpServletResponse response) {
        ...
        facilityService.addFacility(newfacility);
        try {
            request.getRequestDispatcher("view/facility/addVilla.jsp").forward(request, response);
        } catch (ServletException e) {
            e.printStackTrace();
        } catch (IOException e) {
            e.printStackTrace();
    ...
    private void showFormRoom(HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            request.getRequestDispatcher("view/facility/addRoom.jsp").forward(request, response);
        } catch (ServletException e) {
            e.printStackTrace();
        } catch (IOException e) {
            e.printStackTrace();
